...
> **当前版本**：`2.7.x.20260624-SNAPSHOT`<br>
> **JDK 基线**：`17`<br>
...
| JDK | `17` |
| 坐标 | `io.github.easy4j:xxljob-spring-boot-starter:2.7.x.20260624-SNAPSHOT` |
| 配置前缀 | `xxljob` |
...
| `UnirestInstance` Bean | ✅ 稳定 | 通过 XxlJobAutoConfiguration, XxlJobMetricsAutoConfiguration 自动注册 |
