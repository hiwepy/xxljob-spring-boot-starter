...
> **Current Version**：`2.7.x.20260624-SNAPSHOT`<br>
> **JDK Baseline**：`17`<br>
...
| JDK | `17` |
| Coordinates | `io.github.easy4j:xxljob-spring-boot-starter:2.7.x.20260624-SNAPSHOT` |
...
| `UnirestInstance` bean | ✅ Stable | Auto-registered via XxlJobAutoConfiguration, XxlJobMetricsAutoConfiguration |
