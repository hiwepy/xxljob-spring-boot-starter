...
**Spring Boot Starter for xxljob**
...
> **Current Version**：`2.0.1.20260603-SNAPSHOT`<br>
> **JDK Baseline**：`17`<br>
...
**xxljob-spring-boot-starter** is a Spring Boot starter that integrates **xxljob** for applications using xxljob. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume xxljob capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using xxljob |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for xxljob |
| JDK | `17` |
| Coordinates | `io.github.easy4j:xxljob-spring-boot-starter:2.0.1.20260603-SNAPSHOT` |
...
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers xxljob beans automatically |
| Property Binding | ✅ Stable | Binds `xxljob.*` to `XxlJobAdminCookieProperties` |
| `XxlJobTemplate` bean | ✅ Stable | Auto-registered via XxlJobAutoConfiguration, XxlJobMetricsAutoConfiguration |
...
<dependency>
    ...
    <version>2.0.1.20260603-SNAPSHOT</version>
</dependency>
```
